...
export const rectangle1 = img({class: "rectangle2", src:"assets/rectangle-svgrepo-com.svg", style: "margin-top: 50px"});  
export const rectangle2 = img({class: "rectangle2", src:"assets/rectangle-svgrepo-com.svg"});
